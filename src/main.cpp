...
#include "file-chunks-producer/dumb-lock-free-file-chunks-producer.h"
...
//        };
        ...
        file_chunks_producer_iface_ptr fc_produser{
            std::make_unique<dump_lock_free_file_chunks_producer>( std::move( f_reader ), chunks_count, chunk_size )
        };
